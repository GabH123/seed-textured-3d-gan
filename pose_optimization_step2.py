...
# Discard bottom 10%
discard_percentage = 0.01 #Original - 0.1, changed to retain all 
thresh_miou = torch.kthvalue(best_proposal_miou, int(discard_percentage*best_proposal_miou.shape[0]), dim=0).values
