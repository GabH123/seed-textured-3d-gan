...
dataset_to_class_name['batch1seed_train']='batch1seed'
dataset_to_class_name['batch1seed_test']='batch1seed'
imagenet_synsets = {
...
vg3k_class_set = ['wing', 'engine', 'fender', 'seat', 'gas_tank', 'handlebar', 
                  ...
                  'neck', 'mane', 'head', 'face', 'mouth', 'nose', 'cockpit', 'trunk', 'horn', 'ear', 'eye', 'beak', 'seed_body',
                  'germinated',
                 ]